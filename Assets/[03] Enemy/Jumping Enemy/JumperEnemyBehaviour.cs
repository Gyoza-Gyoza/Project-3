...
public class JumperEnemyBehaviour : EnemyBehaviour
{
    ...
    public float LaunchSpeed { get { return launchSpeed; } set { launchSpeed = value; } }
    ...
    {
        base.Start();
        State = new JumperEnemyPrepJumpState(this);
        isDead = false;
    }
    ...
    protected override void OnDamaged(GameObject source)
    {
        ...
        //if (State is JumperEnemyDeathState) return;
        StartCoroutine(DamageFlicker());
        //State = new JumperEnemyKnockUpState(this, knockupDuration, CalculateKnockBack(false, source.transform), upDrag, fallForce, downDrag, recoveryTime);
        Debug.Log("Enemy on damage called");
    }
    public override void TakeDamageNoKnockback()
    {
        State = new JumperEnemyStunState(this, 2.5f); 
        StartCoroutine(DamageFlicker());
    }
    ...
    public override void OnDeath()
    {
        ...
        base.OnDeath();
        isDead = true;
        //State = new JumperEnemyDeathState(this, deathKnockUpDuration, CalculateKnockBack(true, PlayerController3P.instance.transform), deathUpDrag, deathFallForce, deathDownDrag, recoveryTime);
    }
