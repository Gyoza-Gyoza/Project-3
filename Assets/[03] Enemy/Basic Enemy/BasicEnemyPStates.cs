...
public class BasicEnemyPState : EnemyState
{
    protected BasicEnemyPBehaviour enemy;
    public BasicEnemyPState(BasicEnemyPBehaviour enemy)
    {
        this.enemy = enemy;
    }
...
public class BasicEnemyPChaseState : BasicEnemyPState
{
    float timer;
    public BasicEnemyPChaseState(BasicEnemyPBehaviour enemy) : base(enemy)
    {
        //Debug.Log("Enemy entering Chase State");
        if (enemy.PreviousState is not BasicEnemyPKnockUpState) enemy.Animator.Play("Walk");
    ...
    private void Chase()
    {
        ...
        {
            NavMeshHit navMesh;
            if (enemy.agent.isOnNavMesh) enemy.agent.SetDestination(PlayerController3P.instance.transform.position);
            else
            {
    ...
    */
    private void CheckWhoIsInRange()
    {
        ...
        {
            enemy.State = new BasicEnemyPPayloadState(enemy);
        }
        */
        if (Vector3.Distance(enemy.transform.position, PlayerController3P.instance.transform.position) <= enemy.attackRange)
        {
            enemy.State = new BasicEnemyPAttackState(enemy);
        }
    }
}

public class BasicEnemyPAttackState : BasicEnemyPState
{
    private float timer = 0f;
    public BasicEnemyPAttackState(BasicEnemyPBehaviour enemy) : base(enemy)
    {
    ...
    public override void ReachTargetAction()
    {
        enemy.State = new BasicEnemyPChaseState(enemy);
    }
}

//public class BasicEnemyPPayloadState : BasicEnemyPState
//{
//    bool attackingPayload = false;
//    public BasicEnemyPPayloadState(BasicEnemyPBehaviour enemy) : base(enemy)
//    {
...
public class BasicEnemyPTauntState : BasicEnemyPState
{
    private Transform target;
    public BasicEnemyPTauntState(BasicEnemyPBehaviour enemy, Transform target) : base(enemy)
    {
        this.target = target;
...
public class BasicEnemyPStunState : BasicEnemyPState
{
    ...
    public bool Stunned
    { get { return stunned; } }
    public BasicEnemyPStunState(BasicEnemyPBehaviour enemy, float duration) : base(enemy)
    {
        timer = 0f;
...
public class BasicEnemyPKnockUpState : BasicEnemyPStunState
{
    ...
    public BasicEnemyPKnockUpState(BasicEnemyPBehaviour enemy, float duration, Vector3 force,
...
public class BasicEnemyPDeathState : BasicEnemyPKnockUpState
{
    public BasicEnemyPDeathState(BasicEnemyPBehaviour enemy, float duration, Vector3 force,
